# scripts/train_dsb2018_baseline.py
...
def build_subset(dataset, allowed_ids):
    """Filtra o dataset completo, mantendo só as imagens do split desejado."""
...
def main():
    ...
    torch.save(model.state_dict(), "outputs/resunet_baseline.pt")
    print("Checkpoint salvo em outputs/resunet_baseline.pt")
